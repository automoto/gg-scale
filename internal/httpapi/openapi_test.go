...
var expectedV1Paths = []string{
	...
	"/v1/leaderboards/{id}/friends",
	"/v1/leaderboards/{id}/periods",
	"/v1/leaderboards/{id}/periods/{period}/top",
	"/v1/leaderboards/{id}/scores",
	"/v1/leaderboards/{id}/top",
	"/v1/parties",
	"/v1/parties/current",
	"/v1/parties/{id}",
	"/v1/parties/{id}/members/me",
	"/v1/parties/{id}/members/{player_id}",
	"/v1/parties/{id}/members/me/ready",
	"/v1/parties/{id}/heartbeat",
	"/v1/parties/{id}/invites",
	"/v1/party-invites",
	"/v1/party-invites/{id}/accept",
	"/v1/party-invites/{id}",
	"/v1/parties/{id}/invite-codes",
	"/v1/parties/{id}/invite-codes/{code_id}",
	"/v1/parties/join",
	"/v1/parties/{id}/queue",
	"/v1/parties/{id}/rematch",
	"/v1/matchmaker/tickets",
	"/v1/matchmaker/tickets/{id}",
	"/v1/players",
	"/v1/players/by-code/{code}",
	"/v1/players/{id}",
	"/v1/presence",
	"/v1/profile",
...
func TestOpenAPIDoc_schemas_carry_examples(t *testing.T) {
	...
	cases := []struct{ schema, property string }{
		...
		{"PublicGameSessionEntry", "player_count"},
