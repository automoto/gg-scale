...
- Idiomatic Go: Use idiomatic golang patterns and best practices.
...
<!-- TODO: add frontend guide to wiki -->
<!-- - Frontend work (control panel/player UI): follow `docs/FRONTEND_GUIDELINES.md` (templ/HTMX behavior checklist) and `docs/FRONTEND_STYLING.md` (Pico CSS conventions, pinned asset versions, CSP constraints). Self-hosted assets only — no CDN, no Tailwind/Alpine, no inline `<script>`/`<style>`. -->
