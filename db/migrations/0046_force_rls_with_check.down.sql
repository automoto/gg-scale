ALTER TABLE feature_grants NO FORCE ROW LEVEL SECURITY;
ALTER TABLE fleets NO FORCE ROW LEVEL SECURITY;
ALTER TABLE fleet_allocation_events NO FORCE ROW LEVEL SECURITY;
ALTER TABLE end_user_invitations NO FORCE ROW LEVEL SECURITY;
ALTER TABLE matchmaking_tickets NO FORCE ROW LEVEL SECURITY;
ALTER TABLE game_server_allocations NO FORCE ROW LEVEL SECURITY;
ALTER TABLE usage_samples NO FORCE ROW LEVEL SECURITY;
ALTER TABLE audit_log NO FORCE ROW LEVEL SECURITY;
ALTER TABLE friend_edges NO FORCE ROW LEVEL SECURITY;
ALTER TABLE leaderboard_entries NO FORCE ROW LEVEL SECURITY;
ALTER TABLE leaderboards NO FORCE ROW LEVEL SECURITY;
ALTER TABLE storage_objects NO FORCE ROW LEVEL SECURITY;
ALTER TABLE sessions NO FORCE ROW LEVEL SECURITY;
ALTER TABLE end_users NO FORCE ROW LEVEL SECURITY;
...
ALTER TABLE feature_grants DISABLE ROW LEVEL SECURITY;
